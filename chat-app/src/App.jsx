    ...
    return (
        <div className='flex justify-between items-center pt-10 pb-36 xl:px-10 container mx-auto'>
            ...
            <nav className='font-medium text-sm flex justify-around items-center gap-10'>
                ...
                <a href='#'>Contact</a>
                <a href='#'>Log In</a>
                <button className='bg-white/20 rounded-4xl px-6 py-3'>
                    Try It Free
                </button>
            </nav>
        </div>
            ...
            <div className='flex justify-around items-center container mx-auto pb-40'>
                <div className='max-w-lg'>
                    ...
                    <div className='flex gap-8'>
                        <button className='bg-white rounded-4xl px-12 py-4 text-chatappblue'>
                            Try It Free
                        </button>
                        <button className='border rounded-4xl px-12 py-4'>
                            Get a Demo
                        </button>
                    </div>
                </div>
...
function Mockup() {
    return (
        <section className='flex flex-col mx-auto container items-center mt-23 mb-25'>
            <h2 className='text-4xl font-poppins font-medium mb-10'>
                Instant Team Chats
            </h2>
            <p className='text-chatappgray/70 max-w-lg text-center'>
